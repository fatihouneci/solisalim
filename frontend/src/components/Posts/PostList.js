                      ...
                      <td className="px-6 py-4">
                        {post.categories.map((cat, i) => {
                          return (
                            <div
                              key={i}
                              className="bg-gray-300 mb-1 rounded p-2"
                            >
                              {cat.name}
                            </div>
                          );
            ...
            <div className="flex items-center justify-center py-10">
              {pager && pager.pages && pager.pages.length && (
                <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px">
                  <Link
                    to={{ search: `?page=1&title=all&category=all` }}
                  ...
                  {pager.pages.map((page) => (
                    <Link
                      key={page}
                      to={{ search: `?page=${page}&title=all&category=all` }}
                  ...
                  <Link
                    to={{
                      search: `?page=${pager.totalPages}&title=all&category=all`,
                    }}
